    ...
    <>
      <nav className=" flex justify-between items-center w-full z-20 fixed top-0  bg-white gap-1 shadow-2xl">
        ...
        <div className="flex items-center gap-5">
          <div>
            <div className="cursor-pointer hover:rounded-2xl hover:bg-slate-200 ">
              <MdHistory fontSize={26} onClick={() => setToggle(!toggle)} />
            </div>
            <div>
              <div
                className={`${
          ...
          <div>
            <div className=" p-1 cursor-pointer  rounded-full bg-gray-300 object-contain mx-2">
              <img
            ...
            >
              <div className="flex flex-col gap-4 bg-white  rounded-3xl w-60 h-60 text-center  ">
                ...
                <div
                  className="cursor-pointer font-semibold flex items-center  justify-evenly"
                  onClick={() => {
                    setToggle(!toggle);
                    localStorage.clear();
                    navigate("/login");
